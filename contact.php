...
<section id="single-page" class="section no-header-image about-us" style="padding-top: 86px;">
                    ...
                    <div class="wpb_wrapper">
                      <div class="vc_row wpb_row vc_inner vc_row-fluid container vc_custom_1475845870743">
                        <div class="wpb_column vc_column_container vc_col-sm-4">
                          ...
                          <div class="vc_row wpb_row vc_row-fluid vc_custom_1475847858282"><div class="wpb_column vc_column_container vc_col-sm-3"><div class="vc_column-inner">
                              <div class="wpb_wrapper">
                          </div>
                          </div>
                          </div>
    ...
    <!--                                      </div>-->
    <!--                                      <form action="" method="post" class="wpcf7-form demo" novalidate="novalidate">-->
    <!--                                          <div style="display: none;"> -->
    <!--                                          <input type="hidden" name="_wpcf7" value="323" /> -->
    <!--                                          <input type="hidden" name="_wpcf7_version" value="5.1.3" /> -->
    <!--                                          <input type="hidden" name="_wpcf7_locale" value="en_US" /> -->
    <!--                                          <input type="hidden" name="_wpcf7_unit_tag" value="wpcf7-f323-p3427-o1" />-->
    ...
    <!--    <textarea name="your-message" cols="40" rows="10" class="wpcf7-form-control wpcf7-textarea" aria-invalid="false" placeholder="THE MESSAGE">-->
    <!--    </textarea>-->
    <!--    </span><br /> -->
